    ...
    private void inicializar() {
        ...
        listaPersonas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(getBaseContext(), AddPersonas.class);
                ...
                intent.putExtra("sexo",personas.get(i).getSexo());
        ...
        fab_agregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getBaseContext(), AddPersonas.class);
        ...
        consultaOrdenada.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AdaptadorPersona adapter = new AdaptadorPersona(Personas.this, personas );
